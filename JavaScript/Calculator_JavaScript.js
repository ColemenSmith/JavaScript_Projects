...
// this section handlles decimal points
...
function Handle_Operator(Next_Operator) {
    ...
    // then updates the operator and ecits from the function
...
const Perform_Calculation = {
    ...
    '*': (First_Operand, Wait_Second_Operand) => {
        return First_Operand * Wait_Second_Operand;
    },
